...
- In one particular case, i.e. for _Elachista_, this is a hemihomonym problem. 

In the taxon core, we only want one row per taxon.  We want to keep the hemihomonyms but remove the taxa which have two distribution records.
